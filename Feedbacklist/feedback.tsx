        ...
        <div key={id} className="flex space-x-4 flex-col">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 flex-col">
              <p className="font-semibold text-gray-900 mt-4">{username}</p>
              <p className="text-sm text-gray-500">{daysAgo(createdAt)}</p>
            </div>
            </div >
            <div className='flex flex-col justify-start  pl-0 mr-0'>
            <p className="text-gray-600 mt-2 pl-0">{feedback}</p>
            <p className="text-gray-600 mt-2 pl-0">{opinion}</p>
