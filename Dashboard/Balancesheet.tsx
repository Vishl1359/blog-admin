type UserData = {
  ...
  const RecentCountUser = () => {
    return (
      <div className="mt-6 w-full  shadow-2xl rounded-xl ">
          ...
          <table className="w-full table-auto border-collapse border-2 border-black">
            <thead>
              ...
              <th className="p-2">  <input type="checkbox" /></th>
                ...
                <th className="p-2">user counts</th>
                <th className="p-2">post conunts</th>
                <th className="p-2">post views</th>
                <th className="p-2"> toatal sharers</th>
              </tr>
            </thead>
            <tbody>
              {Usercount.map((Userdata, index) => (
                <tr key={index} className="border-b hover:bg-blue-500 text-black">
                      <td className="p-2">
                  <input type="checkbox" />
                </td>
